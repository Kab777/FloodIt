...
class GameNotification {
  public:
    virtual void notify(int row, int column, int state) = 0;
};
...
class Game {
   ...
   */
  int colours[5]; // I changed return type to int for consistency
 ...
 public:
   ...
   */
  void notify(int row, int column,int oldState, int newState);// I changed unsigned int to int for consistency
